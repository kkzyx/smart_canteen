...
public class MyToolExecutionRequest{
    private final String id;
    private final String name;
    private final String arguments;

    public MyToolExecutionRequest(String id, String name, String arguments) {
...
//        super();
     ...
     */
    private MyToolExecutionRequest(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object another) {
        ...
        return another instanceof MyToolExecutionRequest ter
                && equalTo(ter);
    }

    private boolean equalTo(MyToolExecutionRequest another) {
    ...
    public static final class Builder {
         ...
         */
        public MyToolExecutionRequest build() {
            return new MyToolExecutionRequest(this);
        }
    }
}