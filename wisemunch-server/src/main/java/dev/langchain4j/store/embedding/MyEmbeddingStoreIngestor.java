 ...
 */
public class MyEmbeddingStoreIngestor {

    private static final Logger log = LoggerFactory.getLogger(MyEmbeddingStoreIngestor.class);
     ...
     */
    public MyEmbeddingStoreIngestor(DocumentTransformer documentTransformer,
                                    DocumentSplitter documentSplitter,
                                    TextSegmentTransformer textSegmentTransformer,
                                    EmbeddingModel embeddingModel,
                                    EmbeddingStore<TextSegment> embeddingStore) {
        this.documentTransformer = documentTransformer;
        this.documentSplitter = getOrDefault(documentSplitter, MyEmbeddingStoreIngestor::loadDocumentSplitter);
        this.textSegmentTransformer = textSegmentTransformer;
        this.embeddingModel = ensureNotNull(
                getOrDefault(embeddingModel, MyEmbeddingStoreIngestor::loadEmbeddingModel),
                "embeddingModel"
        );
     ...
     */
    public static MyIngestionResult ingest(Document document, EmbeddingStore<TextSegment> embeddingStore) {
     ...
     * @return result including information related to ingestion process.
     */
    public static MyIngestionResult ingest(List<Document> documents, EmbeddingStore<TextSegment> embeddingStore) {
     ...
     * @return result including information related to ingestion process.
     */
    public MyIngestionResult ingest(Document document) {
     ...
     * @return result including information related to ingestion process.
     */
    public MyIngestionResult ingest(Document... documents) {
     ...
     * @return result including information related to ingestion process.
     */
    public MyIngestionResult ingest(List<Document> documents) {
        ...
        return new MyIngestionResult(embeddingsResponse.tokenUsage(), ids);
    }
    ...
    public static class Builder {
         ...
         */
        public MyEmbeddingStoreIngestor build() {
            return new MyEmbeddingStoreIngestor(
                    documentTransformer,
                    documentSplitter,
